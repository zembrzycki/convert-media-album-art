...
# Entity platforms this integration provides. Currently just the sensor
# that exposes the fully-resolved URL for ESPHome (or anything else) to
# fetch the converted album art from.
PLATFORMS = ["sensor"]
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Set up the sensor platform (exposes the ESPHome-facing URL entity)
